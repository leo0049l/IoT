...
{   if(buf[0]<'0' &&  buf[0]>'9')return no;
    ...
    if(light[7]=='1')
    {
      light[7]='_';light[8]='w';light[9]='a';light[10]='r';light[11]='n';light[12]='i';
      light[13]='n';light[14]='g';light[15]=' ';
    } 
    else
    {
     light[7]=' ';light[8]=' ';light[9]=' ';light[10]=' ';light[11]=' ';light[12]=' ';
      light[13]=' ';light[14]=' ';light[15]=' ';  
    }
    return light;
}
#endif
...
{
    return coap_make_response(scratch, outpkt, (const uint8_t *)&light, 16, id_hi, id_lo, &inpkt->tok, COAP_RSPCODE_CONTENT, COAP_CONTENTTYPE_TEXT_PLAIN);
}
